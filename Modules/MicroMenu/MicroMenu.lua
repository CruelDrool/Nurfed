...
-- Level 1
local mainmenu = {"TITLE", "BLANK", "SOCIAL_BUTTON", "SEPARATOR", "CHARACTER_BUTTON", "SPELLBOOK_ABILITIES_BUTTON", "TALENTS_BUTTON", "ACHIEVEMENT_BUTTON", "QUESTLOG_BUTTON", "LOOKINGFORGUILD", "DUNGEONS_BUTTON", "COLLECTIONS", "ADVENTURE_JOURNAL", "BLIZZARD_STORE", "SEPARATOR", "GAME_MENU", }
